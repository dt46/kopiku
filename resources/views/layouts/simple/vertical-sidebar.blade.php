				...
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list">
						<a class="sidebar-link sidebar-title" href="#"><i data-feather="layout"></i><span
								class="lan-7">Page layout</span></a>
						<ul class="sidebar-submenu">
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu"
							...
							<li><a href="{{route('chat-video')}}"
									class="{{ Route::currentRouteName()=='chat-video' ? 'active' : '' }}">Video chat</a>
							</li>
						</ul>
					</li>
					<li class="sidebar-list">
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu"
							...
							<li><a href="{{route('tag-pills')}}"
									class="{{ Route::currentRouteName()=='tag-pills' ? 'active' : '' }}">Tag & pills</a>
							</li>
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu"
							...
							<li><a href="{{route('tilt')}}"
									class="{{ Route::currentRouteName()=='tilt' ? 'active' : '' }}">Tilt Animation</a>
							</li>
							<li><a href="{{route('wow')}}"
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu"
							...
							<li><a href="{{route('flag-icon')}}"
									class="{{ Route::currentRouteName()=='flag-icon' ? 'active' : '' }}">Flag icon</a>
							</li>
							...
							<li><a href="{{route('ionic-icon')}}"
									class="{{ Route::currentRouteName()=='ionic-icon' ? 'active' : '' }}">Ionic icon</a>
							</li>
						</ul>
					</li>
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu"
							...
							<li><a href="{{route('buttons')}}"
									class="{{ Route::currentRouteName()=='buttons' ? 'active' : '' }}">Default Style</a>
							</li>
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu"
							...
							<li><a href="{{route('chart-apex')}}"
									class="{{ Route::currentRouteName()=='chart-apex' ? 'active' : '' }}">Apex Chart</a>
							</li>
					...
					<li class="sidebar-list"><a
							...
							href="{{route('landing-page')}}"><i data-feather="cast"> </i><span>Landing page</span></a>
					</li>
					<li class="sidebar-list"><a
					...
					<li class="sidebar-list"><a
							class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='layout-light' ? 'active' : '' }}"
							href="{{ route('layout-light') }}" target="_blank"><i
								data-feather="anchor"></i><span>{{ trans('lang.Starter kit') }}</span></a></li>
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu"
							...
							<li><a href="{{route('gallery')}}"
									class="{{ Route::currentRouteName()=='gallery' ? 'active' : '' }}">Gallery Grid</a>
							</li>
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu"
							...
							<li><a href="{{route('simple-mde')}}"
									class="{{ Route::currentRouteName()=='simple-mde' ? 'active' : '' }}">MDE editor</a>
							</li>
							<li><a href="{{route('ace-code-editor')}}"
									class="{{ Route::currentRouteName()=='ace-code-editor' ? 'active' : '' }}">ACE code
									editor</a></li>
						</ul>
					</li>
					<li class="sidebar-list"><a
